...
function create_fragment(ctx) {
  ...
  return {
    c() {
      head = element("head");
      title = element("title");
      t0 = text("about - toodoo");
      t1 = space();
      p = element("p");
      t2 = text("and this is about page");
      this.h();
    },
    l(nodes) {
      ...
      t0 = claim_text(title_nodes, "about - toodoo");
      title_nodes.forEach(detach);
      head_nodes.forEach(detach);
      t1 = claim_space(nodes);
      p = claim_element(nodes, "P", { class: true });
      var p_nodes = children(p);
      t2 = claim_text(p_nodes, "and this is about page");
      p_nodes.forEach(detach);
      this.h();
    },
    h() {
      attr(p, "class", "text-lg underline");
    },
    m(target, anchor) {
